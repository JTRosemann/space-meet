    ...
    client_process_net_updates() : void {
        ...
        //            this.ghosts.server_pos_other.state = this.cp_state(other_server_state);
                ...
                if(this.client_smoothing) {
                    p.state = s_lerp( p.state, ghost_pos_other, this.physics_dt*this.client_smooth);
                } else {
            ...
            if(!this.client_predict && !this.naive_approach) {
                ...
                if(this.client_smoothing) {
                        this.get_self().state = s_lerp( this.get_self().state, local_target, this.physics_dt*this.client_smooth);
                } else {
