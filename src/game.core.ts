...
class game_core {
    instance; server; world; players; _pdt; _pdte; local_time; _dt; _dte; server_time; laststate; keyboard; audio_ctx; listener; panner; jitsi_connect; user_id; physics_loop;
    ...
    server_on_update_cid = function (u_id) {
    ...
    cp_pos = function(a) { return {x:a.x,y:a.y}; };
//copis the state of the player
    ...
    v_add = function(a,b) { return { x:fixed(a.x+b.x), y:fixed(a.y+b.y) }; };
    //Subtract a 2d vector with another one and return the resulting vector
    v_sub = function(a,b) { return { x:fixed(a.x-b.x), y:fixed((a.y-b.y)) }; };
    //Multiply a 2d vector with a scalar value and return the resulting vector
    v_mul_scalar = function(a,b) { return {x: fixed(a.x*b) , y:fixed(a.y*b) }; };
    //For the server, we need to cancel the setTimeout that the polyfill creates
    stop_update = function() {  window.cancelAnimationFrame( this.updateid );  };
    //lerp for states
    s_lerp = function(s,ts,t) {
        return {
    ...
    */
    ...
    unpack_server_data = function(data) {
        let p_s = {};
    ...
    */
    ...
    client_onserverupdate_recieved = function(raw_data){
    ...
    */
    ...
    client_onnetmessage = function(data) {//FIXME: replace every send with emit & remove this
